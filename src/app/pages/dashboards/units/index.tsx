...
export default function Units() {
  ...
  const columns = useMemo<ColumnDef<UnitItem>[]>(() => [...defaultColumns], []);
    ...
    <Page title="Units">
      ...
      <Transition appear show={isDeleteOpen} as={Fragment}>
        ...
        >
          ...
          >
            <DialogPanel className="dark:bg-dark-700 fixed top-0 left-0 flex w-full transform-gpu flex-col bg-white transition-transform duration-200">
              <div className="dark:bg-dark-800 flex justify-between bg-gray-200 px-4 py-3 sm:px-5">
                <DialogTitle
                  as="h3"
                  className="dark:text-dark-100 items-center text-base font-medium text-gray-800"
                >
              ...
              <div className="p-4">
                {modalState === "pending" && (
                  <p className="dark:text-dark-300 text-gray-600">
              ...
              <div className="dark:bg-dark-800 flex justify-end gap-2 bg-gray-50 px-4 py-3 sm:px-5">
                {modalState === "pending" && (
                  <>
                    <Button
                      variant="outlined"
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <Switch
                      ...
                      disabled={formLoading}
                    />
                    <span className="dark:text-dark-300 text-sm text-gray-700">
                      فعال
                    </span>
                  </div>
